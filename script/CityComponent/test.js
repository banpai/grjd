  ...
  new Vue({
      ...
      methods: {
        ...
        submitForm:function(){
          ...
          formInfoJson.departmentName = this.chargeDeparment;
          formInfoJson.ownershipUnitId = this.ownershipUnitID;
          formInfoJson.ownershipUnitName = this.ownershipUnit;
          formInfoJson.maintenanceUnitId = this.maintenanceUnitID;
          formInfoJson.maintenanceUnitName = this.maintenanceUnitName;
        ...
        checkValue: function() {
          ...
          if (this.componentSecondType ==""||this.componentSecondType==null) {
            api.toast({
                msg: '部件子类型不能为空',
                duration: 2000,
                location: 'bottom'
          ...
          if (this.initialInvestigationTime_computed ==""||this.initialInvestigationTime_computed==null) {
            api.toast({
                msg: '初始调查时间不能为空',
                duration: 2000,
                location: 'bottom'
        ...
        submit:function(){
          ...
          checkPhone: function() {
            var phone =this.maintenancePersonPhone;
