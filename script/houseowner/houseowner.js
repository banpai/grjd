    ...
    new Vue({
        ...
        created: function() {
            ...
            if (that.isBrowser) { //在浏览状态下 显示数据
                ...
                this.buiName=this.params.buiName;
                this.entityId=this.params.entityId;
                this.address=this.params.address;
                this.roomNum=this.params.roomNum;
                this.buiID = this.params.buiID;
                ...
                this.houseid = this.params.houseid;
            ...
            buildingf: function() {
                ...
                api.addEventListener({
                    ...
                    if (ret) {
                        ...
                        that.buiName=buiInfo.buiName;
                        that.entityId=buiInfo.entityId;
                        that.address=buiInfo.address;
                        that.roomNum=buiInfo.roomNum;
                        that.buiID = buiInfo.buiID;
                    } else {
                        alert(JSON.stringify(err));
                    }
                });
          ...
          // },
            ...
            submit: function() {
                if (this.isBrowser) {
                    ...
                    if (!this.houseowner ==""||!this.houseowner==null) {
                      postjson.HOUSE_OWNER = this.houseowner;
                    }
                    else {
                      alert("请输入户号");
                      return false;
                    ...
                    //刷新列表数据JSON用
                    var refreshBuild = {};
                    refreshBuild.buiName=this.buiName;
                    refreshBuild.entityId=this.entityId;
                    refreshBuild.address=this.address;
                    refreshBuild.roomNum=this.roomNum;
                    refreshBuild.buiID = this.buiID;
                    reslutjson.refreshBuild = refreshBuild;
