        ...
        api.addEventListener({
            ...
            if (ret) {
                ...
                for(var num in _self.items){
                  if(_self.items[num].id==myJson.enterprise.id){
                    for(mykey in myJson.enterprise){
                      if(mykey=="houseid"){
                        _self.items[num]["houseId"] = myJson.enterprise[mykey];
                      }else{
                        _self.items[num][mykey] = myJson.enterprise[mykey];
                      }
