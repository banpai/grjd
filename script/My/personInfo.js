...
apiready = function(){
   ...
   var vue = new Vue({
     ...
     created:function(){
      ...
      // that.userName = $api.getStorage('userinf').userName;
      // that.sex = $api.getStorage('userinf').sex;
      // that.mobilePhone = $api.getStorage('userinf').phone;
      // that.email = $api.getStorage('userinf').email;
      // that.department = $api.getStorage('userinf').dept;
