    ...
    new Vue({
        ...
        created: function() {
            ...
            if (that.isBrowser) { //在浏览状态下 显示数据
                that.edited = that.params.edited;
                ...
                that.entityId = that.params.entityId;
                that.gridId = that.params.gridId;
                ...
                if (!isNaN(index) && index < 6) {
                    ...
                    this.houseUseId = that.params.useType;
                }; //房屋用途
                ...
                if (!isNaN(index)) {
                    ...
                    this.actualUseId = that.params.actualUseType;
                }; //实际用途
            } else { //ret.status
            };
            <!--获取扩展信息开始-->
        ...
        methods: {
            initBuiInfo: function(buildId) {
                ...
                api.ajax({
                    ...
                    if (ret.success) {
                        ...
                        that.unit = "";
                        that.unitId = ""
                        that.entityId = ret.data.entityId;
                        that.gridId = ret.data.gridId;
                    } else {
                        //alert( "加载建筑单元失败!" );
                        api.toast({
                            msg: '加载建筑单元失败!',
            ...
            submit: function() {
                if (this.isBrowser) {
                    ...
                    /* 基本房屋信息 */
                    postjson.ENTITYID = this.entityId;
                    postjson.GRIDID = this.gridId;
                    if (!this.isNew) {
                    ...
                    if (!this.houseNum == "" || !this.houseNum == null) {
                        postjson.roomNum = this.houseNum;
                    } else {
                        alert("请输入房号");
                        return false;
                    };
