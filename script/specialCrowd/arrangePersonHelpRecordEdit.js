    ...
    new Vue({
        ...
        created: function () {
            ...
            if (api.pageParam.obj) {
                this.temf = api.pageParam.obj;
                this.isNew = false; //不是新增
                // 处理附件编辑
                this.temf.attachUrl && this.handleAttach(this.temf.attachUrl, this.temf.attachId);
            }
        ...
        methods: {
            ...
            initSelectData: function () {
                ...
                jsonData.data.forEach(function (value) {
                    ...
                    // if (value.parentKey == "score") {
                    //     that.f.overallEval_arr.push({
                    //         text: value.extendAttributeValue,
                    //         status: 'normal',
                    //         key: value.extendAttributeKey
                    //     })
                ...
                var _self = this;
                console.log(UICore.serviceUrl + 'mobile/MobileSpecialHelpRecord.shtml?act=helpRecordDetail&helpRecordId=' + helpRecordId + '&typeCode=1');
                api.ajax({
                    url: UICore.serviceUrl + 'mobile/MobileSpecialHelpRecord.shtml?act=helpRecordDetail&helpRecordId=' + helpRecordId + '&typeCode=1',
                    method: 'post',
                }, function (ret, err) {
                    api.hideProgress();
                    if (ret) {
            ...
            save: function () {
                ...
                tempjson.overallEval = this.f.overallEval //综合评价
                ...
                this.uploadAttachForHelpRecord(function (r) {
                    ...
                    var parameterToken = '?act=addOrEditReleaseHR&data=' + JSON.stringify(postjson);
