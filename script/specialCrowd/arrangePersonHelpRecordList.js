...
apiready = function() {
    new Vue({
            ...
            this.config = {
                ...
                toolbar: [, {
                    ...
                    editBaseHousehold: function(obj, index) {
                        api.openWin({
                            name: 'arrangePersonHelpRecordEdit',
                            url: './arrangePersonHelpRecordEdit.html',
                    ...
                    delete: function(obj, index) {
                        ...
                        var parameterToken = '?act=deleteHelpRecords&helpRecordId=' +obj.id+'&typeCode=1';
                        api.ajax({
        ...
        methods: {
            ...
            addData: function() {
                api.openWin({
                    name: 'arrangePersonHelpRecordAdd',
                    url: './arrangePersonHelpRecordAdd.html',
                    pageParam: {
                        people: this.params
                    }
                });
