apiready = function() {
    var vue = new Vue({
        ...
        methods: {
            loadList:function(){
              var url = UICore.serviceUrl+'mobile/mobileWf.shtml?act=groupList&page='+this.page+'&rows='+this.rows+'&accountId='+$api.getStorage('userinf').accountId;
              console.log(url);
              api.ajax({
                url : url,
                tag : 'grid',
