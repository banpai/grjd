apiready = function() {
    var vue = new Vue({
        ...
        methods: {
            loadList:function(){
              console.log(UICore.serviceUrl+'mobile/mobileWf.shtml?act=deptList&page='+this.page+'&rows='+this.rows+'&accountId='+$api.getStorage('userinf').accountId);
              var url = UICore.serviceUrl+'mobile/mobileWf.shtml?act=deptList&page='+this.page+'&rows='+this.rows+'&accountId='+$api.getStorage('userinf').accountId
              api.ajax({
                url : url,
                tag : 'grid',
                method : 'get'
            ...
            loadDetailList:function(){
              var url = UICore.serviceUrl+'mobile/mobileWf.shtml?act=personList&page='+this.depage+'&rows='+this.derows+'&deptId='+this.deptId;
              console.log(url);
              api.ajax({
                url : url,
                tag : 'grid',
