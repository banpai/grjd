    ...
    var vue = new Vue({
        ...
        methods: {
            ...
            loadList: function() {
                var that = this;
                this.postjson.pageNow = 1;
                console.log("下拉刷新: " + UICore.serviceUrl + 'mobile/mobileInterfaceForResident.shtml?act=queryResidentInfo&accountId='+this.accountId+'&data=' + JSON.stringify(this.postjson));
                api.ajax({
                    url: UICore.serviceUrl + 'mobile/mobileInterfaceForResident.shtml?act=queryResidentInfo&accountId='+this.accountId+'&data=' + JSON.stringify(this.postjson),
                    method: 'get',
                }, function(ret, err) {
            ...
            loadBottom: function() { //上拉加载
                ...
                api.addEventListener({
                    ...
                    console.log(UICore.serviceUrl + 'mobile/mobileInterfaceForResident.shtml?act=queryResidentInfo&accountId='+this.accountId+'&data=' + JSON.stringify(that.postjson));
                    api.ajax({
                        url: UICore.serviceUrl + 'mobile/mobileInterfaceForResident.shtml?act=queryResidentInfo&accountId='+this.accountId+'&data=' + JSON.stringify(that.postjson),
                        method: 'get',
                    }, function(ret, err) {
                        api.hideProgress();
                        if (ret.success) {
            ...
            query:function() {
                ...
                console.log(UICore.serviceUrl + 'mobile/mobileInterfaceForResident.shtml?act=queryResidentInfo&accountId='+this.accountId+'&data=' + JSON.stringify(this.postjson));
                api.ajax({
                    url: UICore.serviceUrl + 'mobile/mobileInterfaceForResident.shtml?act=queryResidentInfo&accountId='+this.accountId+'&data=' + JSON.stringify(this.postjson),
                    method: 'get',
                }, function(ret, err) {
