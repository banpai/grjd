window.apiready = function() {
    var vue = new Vue({
      ...
      created:function(){
        ...
        this.params.data_area_code = info.dataAreaCode;
        this.loadList();
        this.loadBottom();
        this.refreshHeader();
        var _self = this;
        api.addEventListener({
            name: 'searchMassesVisit'
        }, function(ret, err) {
            if (ret) {
      ...
      methods:{
          loadList:function(){
            ...
            this.params.visitObjectName = this.visitObjectName;
            console.log(JSON.stringify(this.params));
            var _self = this;
            console.log(UICore.serviceUrl + 'mobile/mobileInterfaceForMassesVisit.shtml?act=query&data=' + JSON.stringify(this.params));
            api.ajax({
                url: UICore.serviceUrl + 'mobile/mobileInterfaceForMassesVisit.shtml?act=query&data=' + JSON.stringify(this.params),
                method: 'get',
            },function(ret, err){
