window.apiready = function(){
    new Vue({
      ...
      data:{
        ...
        staff:"",//工作人员
        serviceTime:"",//服务时间
        serviceTimeDm:"",//服务时间的日期
        serviceTimeHm:"",//服务时间的时分秒
        booker:"",//登记人
        descriration:"",//内容描述
        serviceType_arr:[
          {
      ...
      created:function(){
        ...
        if (this.mStatus == "isBrownse") {
          ...
          if(_self.formJSON.serviceTime){
            _self.serviceTime= _self.formJSON.serviceTime.substring(0,16);//服务时间
            _self.serviceTimeHm = _self.formJSON.serviceTime.substring(11,16);//服务时间
          }
        ...
        serviceTimef:function(){
          ...
          if (!_self.isClick) {
              ...
              api.addEventListener({
                  ...
                  if (ret) {
                      _self.serviceTimeDm = ret.value.key1;
                      var defaultTime = "";
                      if(_self.serviceTimeHm==""){
                        defaultTime = UICore.getnowtime();
                        console.log(defaultTime);
                      }else{
                        defaultTime = "2017-01-01 "+_self.serviceTimeHm;
                      }
                      api.openPicker({
                          type: 'time',
                          date: defaultTime,
                          ...
                          if (ret) {
                              ...
                              _self.serviceTimeHm =hour+":"+minute;
                              _self.serviceTime = _self.serviceTimeDm + " " + _self.serviceTimeHm;
                              console.log(_self.serviceTime);
                          } else {
                              alert(JSON.stringify(err));
                          }
                      });
